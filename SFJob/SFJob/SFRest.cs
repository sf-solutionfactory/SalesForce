...
namespace SFJob
{
    class SFRest
    {
                    ...
                    foreach (string body in File.ReadAllLines(fullPathName))
                    {
                        try
                        {
                            ...
                            else if (modulo == "VIA")
                            {
                                ...
                                MetodoPost(tipoToken, autorizacionToken, cuerpo, url_viajes, nombreArchivo, errores);
                            }
                            else if (modulo == "FAC")
                            {
                    ...
                    foreach (string body in File.ReadAllLines(fullPathName))
                    {
                        try
                        {
                            ...
                            else if (modulo == "VIA")
                            {
                                ...
                                MetodoPut(tipoToken, autorizacionToken, cuerpo, url_viajes, nombreArchivo, errores);
                            }
                            else if (modulo == "FAC")
                            {
        ...
        public async void MetodoPut(string token_type, string token, string body, string endPoint, string archivo, List<string> errores)
        {
            HttpClient apiCallClient = new HttpClient();
        ...
        public async void MetodoPost(string token_type, string token, string body, string endPoint, string archivo, List<string> errores)
        {
            HttpClient apiCallClient = new HttpClient();
